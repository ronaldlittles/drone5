...
vec3 getPointAt(float t) {
  ...
  float radius = 50.0; // Adjust the radius of the track
  float height = 10.0; // Adjust the height of the track

  float x = sin(t * 3.0) * radius + 5.0;
  float y = sin(t * 10.0) * height + cos(t * 17.0) * height + 5.0;
  float z = sin(t) * sin(t * 4.0) * radius + 5.0;
