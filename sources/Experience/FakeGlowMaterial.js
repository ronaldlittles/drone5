...
class FakeGlowMaterial extends ShaderMaterial {
  ...
  constructor(parameters = {}) {
    ...
    this.uniforms = {
       ...
       * @default 0.5
       */
      glowSharpness: new Uniform(parameters.glowSharpness !== undefined ? parameters.glowSharpness : .5),
       ...
       */
      glowColor: new Uniform(parameters.glowColor !== undefined ? new Color(parameters.glowColor) : new Color("#0000ff")),
